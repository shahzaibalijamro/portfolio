...
export const Icons = {
  ...
  MaterialUIIcon: (props: IconProps) => (
  ...
  FramerMotionIcon: (props: IconProps) => (
  ...
  nestjs: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...props}>
      <title>NestJS</title>
      {/* Simplified cat head (NestJS logo) */}
      <path
        d="M8 10 L9 4 L11 8 M13 8 L15 4 L16 10 M6 20h12l-3-8H9l-3 8z"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
  ...
  claude: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...props}>
      ...
      {/* Stylized 'C' letter */}
      <path
        d="M18 6c-3.3 0-6 2.7-6 6s2.7 6 6 6"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
  ...
  githubActions: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...props}>
      ...
      <circle
        ...
        strokeWidth="2"
      />
      <polygon points="9,7 9,17 18,12" fill="currentColor" />
    </svg>
  ),
  aws: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...props}>
      ...
      {/* AWS "smile" arch */}
      <path
        d="M2 12c0-5.5 4.5-10 10-10s10 4.5 10 10c0 2.2-.7 4.2-1.9 5.8l-1.5-1.5c.9-1.2 1.4-2.7 1.4-4.3 0-4.4-3.6-8-8-8S4 7.6 4 12c0 1.6.5 3.1 1.4 4.3L3.9 17.8C2.7 16.2 2 14.2 2 12z"
        fill="currentColor"
      />
    </svg>
  ),
  ...
  redis: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...props}>
      ...
      {/* Keyhole / key shape */}
      <path
        d="M15 7a5 5 0 1 0-5 5 5 5 0 0 0 5-5zM7 15l3 3 1.5-1.5L10 15l-3-3"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
  ...
  socketio: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...props}>
      ...
      <circle
        ...
        strokeWidth="2"
      />
      <polygon points="13,4 7,14 12,14 11,20 17,10 12,10" fill="currentColor" />
    </svg>
  ),
  openai: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...props}>
      <title>OpenAI</title>
      {/* Sparkle / star – generic AI icon */}
  ...
  firebase: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...props}>
      ...
      {/* Simple flame shape */}
      <path
        d="M12 3c-2 3-4 7-4 10 0 5 4 9 9 9s9-4 9-9c0-3-2-7-4-10-1.2 2.5-2.8 5-4.5 7C15.8 8 14.2 5.5 12 3z"
        fill="currentColor"
      />
    </svg>
  ),
